...
The vNext Phase A architecture and boundaries are in `docs/VNEXT_ARCHITECTURE.md`. The 13 exact integration pins are recorded in the project-local `.howhow/integration-manifest.json`; reference-only entries are never called live.
