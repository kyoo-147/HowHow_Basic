...
See `docs/RELEASE_VERIFICATION_MATRIX.md`. Unit tests, the deterministic detailed fixture, optional integration conformance, live APIs, real experiments, human scientific review, and submission authorization are separate evidence classes. The detailed fixture is explicitly synthetic and does not produce findings.
